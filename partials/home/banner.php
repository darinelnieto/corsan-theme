                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-md-8 col-lg-7">
                                <p class="short-description">
                                    <?php 
                                        if($product['is_it_a_product']){
                                            echo get_field('short_description', $prod->ID); 
                                        }else{
                                ...
                                <div class="ctas-container">
                                    <a href="<?php if($product['is_it_a_product']): echo get_permalink($prod->ID); else: echo $product['cta_link']; endif; ?>" class="permalink-product">
                                        <?php if(get_bloginfo("language") == "en-US"): echo "Learn more"; else: echo "Conocer más"; endif; ?>
                                    </a>
                                    <a href="<?= get_field('solutions_page'); ?>" class="solutions-link">
                            ...
                            <div class="col-12 col-md-4 col-lg-5">
                                <?php if($product['is_it_a_product']): ?>
                                    <img src="<?= get_the_post_thumbnail_url($prod->ID); ?>" alt="<?= get_the_title($prod->ID); ?>" class="product-image">
                                <?php else: ?>
                                    <img src="<?= $product['main_image']['url']; ?>" alt="<?= $product['main_image']['title']; ?>" class="product-image">
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endforeach; ?>
